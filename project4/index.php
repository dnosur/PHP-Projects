...
if(isset($_POST['Sort'])){
    ...
    $connect->query('UPDATE category SET selected = FALSE');
    $connect->query('UPDATE category SET selected = TRUE where category = "' . $category . '";');
}
...
if(isset($_POST['Comment'])){
    $connect->query("INSERT INTO comments (userid, raiting, comment, carid) VALUES(".$user['id'].", ".$_POST['raiting'].", '".$_POST['comment']."', ".$_POST['id'].")");
}

if(isset($_POST['Remove'])){
    $connect->query("DELETE FROM cars WHERE id = ".$_POST['id']."; ");
    $connect->query("DELETE FROM screens WHERE gameid = ".$_POST['id']."; ");
    $connect->query("DELETE FROM comments WHERE gameid = ".$_POST['id']."; ");
}

if(isset($_POST['Change'])){
    $connect->query("UPDATE cars SET about = '".$_POST['about']."', img ='".$_POST['img']."', price = ".$_POST['price'].", category = '".$_POST['category']."', name = '".$_POST['name']."' WHERE id = ".$_POST['id']."");
}

if(isset($_POST['Add'])){
    $connect->query("INSERT INTO cars (img, price, about, category, name) VALUES ('".$_POST['img']."', ".$_POST['price'].", '".$_POST['about']."' ,'".$_POST['category']."', '".$_POST['name']."');");
}
...
<body style="background: linear-gradient(to right, rgb(113, 129, 173), rgb(71, 92, 209)) ">
  ...
  <div class="container-fluid">
    <form action="index.php" method = 'post'>
      ...
      <button class="navbar-brand" name="Home" style="background: transparent; outline: none; border: 0;"><img src="https://img.icons8.com/color/48/null/bmw--v1.png" width="50" height="45"></button>
    </form>
